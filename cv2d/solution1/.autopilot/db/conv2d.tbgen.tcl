...
set C_modelArgList {
	{ input_r int 32 regular {array 25 { 1 3 } 1 1 }  }
	{ kernel int 32 regular {array 9 { 1 3 } 1 1 }  }
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "511", "EstimateLatencyMax" : "517",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "511", "Max" : "517"}
	, {"Name" : "Interval", "Min" : "512", "Max" : "518"}
]}
...
set Spec2ImplPortList { 
	input_r { ap_memory {  { input_r_address0 mem_address 1 5 }  { input_r_ce0 mem_ce 1 1 }  { input_r_q0 mem_dout 0 32 } } }
