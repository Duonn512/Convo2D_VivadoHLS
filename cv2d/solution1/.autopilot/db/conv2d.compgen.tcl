...
set ID 1
set hasByteEnable 0
set MemName conv2d_line_buffer
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename input_r \
    op interface \
    ports { input_r_address0 { O 5 vector } input_r_ce0 { O 1 bit } input_r_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename kernel \
    op interface \
    ports { kernel_address0 { O 4 vector } kernel_ce0 { O 1 bit } kernel_q0 { I 32 vector } } \
} "
} else {
