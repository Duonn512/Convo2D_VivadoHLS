...
set IPName      "conv2d"
set Version     "0.0"
set DisplayName "cv2d_lbuf_sol3"
set Revision    "0"
...
set Interfaces {
    s_axi_cv_io {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_cv_io"
        param_prefix "C_S_AXI_CV_IO"
        addr_bits "9"
        ...
        memories "input_r {base_address 128 range 128} kernel {base_address 256 range 64} output_r {base_address 320 range 64}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 490 II x}
