...
static  char aesl_internal__OC_str9[60] = "D:/CodesNStuffs/Hardware_Des_Lab/project_base/conv2D_test.c";
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @AESL_WRAP_conv2d([5 x i32]* %%12, [3 x i32]* %%13, [3 x i32]* %%14) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_24_count);
  AESL_WRAP_conv2d(llvm_cbe_tmp__12, llvm_cbe_tmp__13, llvm_cbe_tmp__14);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
...
llvm_cbe_tmp__109:
if (AESL_DEBUG_TRACE)
printf("\n  call void @_assert(i8* getelementptr inbounds ([42 x i8]* @aesl_internal_.str8, i64 0, i64 0), i8* getelementptr inbounds ([60 x i8]* @aesl_internal_.str9, i64 0, i64 0), i32 69) nounwind, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_277_count);
