...
localparam
    ...
    ADDR_KERNEL_BASE   = 9'h100,
    ADDR_KERNEL_HIGH   = 9'h13f,
...
//------------------------Local signal-------------------
    ...
    wire                          int_input_r_we0;
    wire [3:0]                    int_input_r_be0;
    wire [31:0]                   int_input_r_d0;
...
assign RVALID  = (rstate == RDDATA) & !int_input_r_read & !int_kernel_read & !int_output_r_read;
...
assign int_input_r_we0       = 1'b0;
assign int_input_r_be0       = 1'b0;
assign int_input_r_d0        = 1'b0;
...
assign int_input_r_we1       = int_input_r_write & WVALID;
assign int_input_r_be1       = WSTRB;
assign int_input_r_d1        = WDATA;
// kernel
assign int_kernel_address0   = kernel_address0;
assign int_kernel_ce0        = kernel_ce0;
assign int_kernel_we0        = 1'b0;
assign int_kernel_be0        = 1'b0;
assign int_kernel_d0         = 1'b0;
assign kernel_q0             = int_kernel_q0;
assign int_kernel_address1   = ar_hs? raddr[5:2] : waddr[5:2];
